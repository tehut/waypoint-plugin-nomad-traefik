...
install:
	...
	# OSX version instead =>
	# cp -v ./bin/linux_amd64/waypoint-plugin-${PLUGIN_NAME}* /Users/jeffwecan/workspace/es-hashistack/circleci_runners
	cp -v ./bin/${_ARCH}_amd64/waypoint-plugin-${PLUGIN_NAME}* ${HOME}/Library/Preferences/waypoint/plugins
